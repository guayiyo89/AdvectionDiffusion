...
# vertices de malla
vh0 = mesh.add_vertex([72.6805, 38.6840, 0])
vh1 = mesh.add_vertex([72.6805, 38.7862, 0])
vh2 = mesh.add_vertex([72.5193, 38.7862, 0])
vh3 = mesh.add_vertex([72.5193, 38.6840, 0])

vh4 = mesh.add_vertex([72.6452, 38.6840, 0])
vh5 = mesh.add_vertex([72.6019, 38.6840, 0])
vh6 = mesh.add_vertex([72.5543, 38.6840, 0])
vh7 = mesh.add_vertex([72.6452, 38.7862, 0])
vh8 = mesh.add_vertex([72.6019, 38.7862, 0])
vh9 = mesh.add_vertex([72.5543, 38.7862, 0])

vh10 = mesh.add_vertex([72.6805, 38.7075, 0])
vh11 = mesh.add_vertex([72.6805, 38.7355, 0])
vh12 = mesh.add_vertex([72.6805, 38.7584, 0])
vh13 = mesh.add_vertex([72.5193, 38.7075, 0])
vh14 = mesh.add_vertex([72.5193, 38.7355, 0])
vh15 = mesh.add_vertex([72.5193, 38.7584, 0])

vh16 = mesh.add_vertex([72.6505, 38.7022, 0])
vh17 = mesh.add_vertex([72.6136, 38.7036, 0])
vh18 = mesh.add_vertex([72.5788, 38.7011, 0])
vh19 = mesh.add_vertex([72.5500, 38.7047, 0])

vh20 = mesh.add_vertex([72.6393, 38.7243, 0])
vh21 = mesh.add_vertex([72.5983, 38.7293, 0])
vh22 = mesh.add_vertex([72.5712, 38.7226, 0])
vh23 = mesh.add_vertex([72.5489, 38.7326, 0])

vh24 = mesh.add_vertex([72.6567, 38.7553, 0])
vh25 = mesh.add_vertex([72.6237, 38.7449, 0])
vh26 = mesh.add_vertex([72.6164, 38.7622, 0])
vh27 = mesh.add_vertex([72.5802, 38.7544, 0])
vh28 = mesh.add_vertex([72.5498, 38.7555, 0])

vh29 = mesh.add_vertex([72.7043, 38.6840, 0])
vh30 = mesh.add_vertex([72.7043, 38.8096, 0])
vh31 = mesh.add_vertex([72.4955, 38.8096, 0])
vh32 = mesh.add_vertex([72.4955, 38.6840, 0])

vh33 = mesh.add_vertex([72.7043, 38.7175, 0])
vh34 = mesh.add_vertex([72.7043, 38.7461, 0])
vh35 = mesh.add_vertex([72.7043, 38.7710, 0])
vh36 = mesh.add_vertex([72.4955, 38.7175, 0])
vh37 = mesh.add_vertex([72.4955, 38.7461, 0])
vh38 = mesh.add_vertex([72.4955, 38.7710, 0])

vh39 = mesh.add_vertex([72.6805, 38.8096, 0])
vh40 = mesh.add_vertex([72.6452, 38.8096, 0])
vh41 = mesh.add_vertex([72.6019, 38.8096, 0])
vh42 = mesh.add_vertex([72.5543, 38.8096, 0])
vh43 = mesh.add_vertex([72.5293, 38.8096, 0])
